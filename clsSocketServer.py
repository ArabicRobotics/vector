        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    # data = data[::-1]
                    threadSetter = threading.Thread(target=self.__datasetter, args=(data,))
                    threadSetter.start()
    ...
    def Start(self):
        ...
        try:
            ...
            while True:
                ...
                threadHandler = threading.Thread(target=self.threaded, args=(self.c,))
                threadHandler.start()
            self.s.close()
            print("Done")
            return True
...
# ------------------------------------------------
    ...
    def send(self, data="hi"):
            ...
            """
            try:
                self.c.sendto(data.encode('utf-8'), (self.addr[0], self.addr[1]))
                return True
            except Exception as e:
